...
Individual modules of the **toolkit** are part of every Teraport software solution: from the standard entry-level solution for a supplier with ten users to custom-built solutions for automotive companies with several thousand users – for engineers and designers as well as for assembly planners and sales and procurement experts, sometimes coupled with a CAD or PDM system, sometimes as a stand-alone solution.
...
Powerful, stable and methodically innovative algorithms ensure the highest performance, even on standard hardware. All modules can be operated in batch mode, facilitating the processing of 3D mass data. Virtually all 3D analysis processes can be fully automated.
